...
- [depup](https://github.com/hpehl/depup): Check dependency versions across Maven and npm ecosystems.
- [mcup](https://github.com/hpehl/mcup): Command-line tool to keep your local maven repository small 📦 and tidy 🧹.
- [mgt](https://github.com/model-graph-tools/tooling): Command line tool to analyze the WildFly management model.
